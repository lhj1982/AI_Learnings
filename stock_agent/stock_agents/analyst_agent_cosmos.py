"""
Cosmos-compatible version of the analyst agent.
...
ANALYST_BASE_PROMPT = """You are a professional equity research analyst. Analyze the stock based on the latest available
...
ANALYST_INSTRUCTIONS = create_json_instructions(
    base_instructions=ANALYST_BASE_PROMPT,
    model_class=StockNote
)

analyst_agent_cosmos = Agent(
    name="EquityAnalyst",
